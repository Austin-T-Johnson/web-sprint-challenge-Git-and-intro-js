...
console.log(`The artist's bio at index 2 is: ${artists[2].bio}.`);
...
function get20s(array) {
 ...
 for (let i = 0; i < array.length; i++) {
   const yearsStr = array[i].years
   const yearsWordsArr = yearsStr.split(' ');
   if (yearsWordsArr >= "1900" && yearsWordsArr < "2000") {
     selectedYears.push(array[i].name);
   }
 }
